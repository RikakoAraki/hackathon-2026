...
すべての文章・タグは「求人を掲載している企業・個人」が書いているていで書いてください。第三者の分析・警告・解説は一切入れない。
危険な求人も、企業が怪しさを隠しながら魅力的に見せようとしている自然な求人文体にしてください。
...
{{
  ...
  "cards": [
    {{
      "id": "card_1",
      "title": "求人タイトル",
      "tags": ["求人広告として企業が掲載するキャッチコピー風タグを2〜4個。分析・警告・第三者コメントは絶対に入れない。例: 高収入・即日払い・未経験歓迎・LINE応募OK・短期OK・社会保険完備・交通費支給 など"],
